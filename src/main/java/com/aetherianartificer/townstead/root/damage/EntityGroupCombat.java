...
public final class EntityGroupCombat {
    ...
    public static float enchantBonus(net.minecraft.world.entity.LivingEntity victim,
        ...
        com.aetherianartificer.townstead.root.gene.types.EntityGroupGeneType.Group group =
                com.aetherianartificer.townstead.root.EntityGroups.of(victim);
        boolean undead = group == com.aetherianartificer.townstead.root.gene.types.EntityGroupGeneType.Group.UNDEAD;
        boolean arthropod = group == com.aetherianartificer.townstead.root.gene.types.EntityGroupGeneType.Group.ARTHROPOD;
