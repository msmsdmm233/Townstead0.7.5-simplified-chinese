...
import com.aetherianartificer.townstead.root.gene.types.GestationLengthGeneType;
import net.minecraft.world.entity.LivingEntity;

/**
 * Server-side resolution of the {@code townstead_roots:gestation_length} gene (the mother's pregnancy
