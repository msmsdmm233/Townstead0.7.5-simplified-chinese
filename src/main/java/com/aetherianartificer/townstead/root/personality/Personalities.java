...
/**
 * A personality allow/deny policy declared on a species, ancestry, or lineage. {@code allow} maps a personality reference (a custom {@link PersonalityDef} id like
 ...
 *
 * <p>Resolution ({@link PersonalityResolver}) walks the identity tree most-specific first: the nearest node
