...
/**
 * The {@link Personalities} allow/deny policy declared by each species, ancestry, or lineage, indexed per level so
 ...
 * them back when rolling a personality. Kept beside the records (rather than on them) so the
