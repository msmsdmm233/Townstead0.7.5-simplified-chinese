...
public final class PersonalityPolicyRegistry {
    ...
    private static volatile Map<ResourceLocation, Personalities> ROOT = Map.of();
    ...
    public static void setRoot(Map<ResourceLocation, Personalities> next) { ROOT = Map.copyOf(next); }
    ...
    public static Personalities origin(ResourceLocation id) { return id == null ? Personalities.EMPTY : ROOT.getOrDefault(id, Personalities.EMPTY); }
}
